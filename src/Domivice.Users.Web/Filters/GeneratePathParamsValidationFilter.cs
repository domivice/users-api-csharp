    ...
    public void Apply(OpenApiOperation operation, OperationFilterContext context)
    {
        ...
        foreach (var par in pars)
        {
            ...
            if (attributes.Any() && openapiParam != null)
            {
                ...
                if (requiredAttr != null) openapiParam.Required = true;
                ...
                if (stringLengthAttr != null)
                {
                    if (stringLengthAttr.NamedArguments.Count == 1)
                        minLength = (int)stringLengthAttr.NamedArguments.Single(p => p.MemberName == "MinimumLength")
                            .TypedValue.Value;
                    maxLength = (int)stringLengthAttr.ConstructorArguments[0].Value;
                }

                var minLengthAttr = attributes.FirstOrDefault(p => p.AttributeType == typeof(MinLengthAttribute));
                if (minLengthAttr != null) minLength = (int)minLengthAttr.ConstructorArguments[0].Value;
                ...
                if (minLength != null) openapiParam.Schema.MinLength = minLength;

                if (maxLength != null) openapiParam.Schema.MaxLength = maxLength;
